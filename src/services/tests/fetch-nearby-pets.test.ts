...
describe('Pets Search Use Case', () => {
  ...
  let sut: FetchNearbyPetsService

  beforeEach(() => {
    petsRepository = new InMemoryPetsRepository()
    orgsRepository = new InMemoryOrgsRepository()
    sut = new FetchNearbyPetsService(petsRepository, orgsRepository)
  })

  it('should be able to search for pets by its city', async () => {
    ...
    const nearbyPets = await sut.findNearby({
      city: 'Fortaleza',
    })

    expect(nearbyPets.pets).toEqual([
